...
namespace HidDemoWindowsForms
{
    public partial class Form1 : Form
    {
        ...
        bool PushbuttonS3Pressed = false;//C�digo nuevo
        bool ToggleLedD2Pending = false;
        bool ToggleLedD4Pending = false; //C�digo nuevo
        //bool Timer0Pending = false; //C�digo nuevo
        //bool Temp0Contando = false; //C�digo nuevo
        uint Temp0Contador = 0;//C�digo nuevo
        uint AdcValue = 0;
